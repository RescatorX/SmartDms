...
export class DocumentInvoiceIssuedEntity extends DocumentEntity {
 ...
 */
  ...
  public static IsExists(documents: DocumentInvoiceIssuedEntity[], document: DocumentInvoiceIssuedEntity): boolean {
    let exists: boolean = documents.findIndex(si => si.uuid == document.uuid) >= 0;
    return exists;
  }

  public static Add(into: DocumentInvoiceIssuedEntity[], from: DocumentInvoiceIssuedEntity[]) {
  ...
  public static Equals(a: DocumentInvoiceIssuedEntity, b: DocumentInvoiceIssuedEntity): boolean {
